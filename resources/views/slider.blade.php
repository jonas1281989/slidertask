<!-- Slider-Task Seite ohne Lootobox-->
<!doctype html>
<html lang="en">
    ...
    <div class="slider-c" style="width: 80%"> <!--abstand oben durch slider-c, kontainer auf 80% der Bildschrimbreite -->
        ...
        <div class="custom-range">
            ...
            <script>    //script eingebunden für Funktionsaufruf
                valueF(0); <!-- Aufruf Funktion valueF() -->
            </script>
        </div>
        ...
        <div align="right">
            ...
            <!-- Weiter Button -->
            <button style="width: 88px" type="button" class="btn btn-primary" id="weiter" onclick="weiterF(2)" disabled> <!--  Buttonformatierung und Aufruf Funktion weiterF() -->
                Weiter
            </button>
        </div>
            ...
            <div class="popup" id="popup" style="display: none">    <!-- Fenster wenn Beenden Button betätigt wurde, durch overlayvis() sichtbar -->
                ...
                <div class="text-right"> <!-- kontainer für Buttons  -->
                    <div style="text-align: center;">
                        <button id="umfragebtn" onclick="umfrage(1)" class="btn btn-primary ">Umfrage</button> <!-- Button für Umfrage, bei click Funktion umfrage() aufrufen -->
